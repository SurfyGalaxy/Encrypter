...
def make_matrix(sha256: str) -> list:
    ...
    mistake = f"{int(sha256, 16):0256b}" # HA binary spam again
...
def aes256(matrices):
    ...
    if encryption == True:
        return i_dont_want_to_keep_doing_this_but_i_want_to_go_to_crux
    else:
        ...
        try:
            ...
            print("Either that wasn't valid ciphertext or you used the wrong key")
